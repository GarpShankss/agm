...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 06, 2024 at 09:30 PM
...
(40, 13, 'Likhith B B', 1400, '', '2024-06-06');
...
(4, 12, 'Likhith B B', 7411077387, 'likhithb98@gmail.com', 'cash on delivery', 'flat no. 272, hassan, tirunelveli, india - 573201', ', manhattan bridge (1) ', 2100, '2024-06-06', 'completed');
...
(65, 13, 'Likhith B B', 'likhith', 'watercoloring', '2000', 'strollly.jpg', 'flower', 10, 8, 'xfhcfhch', '2024-06-06');
...
CREATE TABLE `users` (
  ...
  `class_cost` varchar(5) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `users` (`id`, `name`, `email`, `password`, `user_type`, `placed_on`, `contact`, `class_cost`) VALUES
(1, 'harshini', 'harsh@gmail.com', 'harsh', 'admin', '2021-08-01', NULL, NULL),
(2, 'rathi', 'rathi@gmail.com', 'rathi', 'user', '2021-09-08', NULL, NULL),
(5, 'rekha', 'rekha@gmail.com', 'rekha', 'artist', '2021-10-08', NULL, NULL),
(6, 'nila', 'nila@gmail.com', 'nila', 'artist', '2021-11-08', NULL, NULL),
(7, 'naveen', 'naveen@gmail.com', 'naveen', 'artist', '2021-11-06', NULL, NULL),
(9, 'sanjay', 'sanjay@gmail.com', 'sanjay', 'artist', '2021-11-18', NULL, NULL),
(12, 'Likhith B B', 'likhithb98@gmail.com', '12281998', 'user', '2024-06-06', NULL, NULL),
(13, 'lucky', 'lucky@gmail.com', '00000000', 'artist', '2024-06-06', '+919448861693', '2500'),
(14, 'admin', 'admin@gmail.com', '123456', 'admin', '2024-06-06', NULL, NULL),
(15, 'artist', 'artist@gmail.com', '12281998', 'artist', '2024-06-06', '07411077387', '2000');
